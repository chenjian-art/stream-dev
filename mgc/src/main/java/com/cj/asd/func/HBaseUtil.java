...
/**
 * @Package com.cj.realtime.util.HBaseUtil
 * @Author chen.jian
 * @Date 2025/4/8 下午2:49
 * @description: 4
 */
public class HBaseUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JSONObject jsonObj = getRow(hBaseConnection, "gmall_config", "dim_base_trademark", "1", JSONObject.class);
