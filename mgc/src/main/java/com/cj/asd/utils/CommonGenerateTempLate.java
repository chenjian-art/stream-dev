...
import static com.cj.asd.utils.SiliconFlowApi.generateBadReview;


/**
 * @Package com.cj.asd.utils.CommonGenerateTempLate
 * @Author chen.jian
 * @Date 2025/5/8 16:59
 * @description:
 */
public class CommonGenerateTempLate {
    ...
    private static final String API_TOKEN = "sk-yqgmhvxaiwixzzncrnnnchdqqkruaeijpaeqmpwtxnajpbml";
