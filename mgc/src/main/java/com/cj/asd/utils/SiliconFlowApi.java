...
/**
 * @Package com.cj.asd.utils.SiliconFlowApi
 * @Author chen.jian
 * @Date 2025/5/8 18:02
 * @description:
 */
public class SiliconFlowApi {
    ...
    private static final String SILICON_API_TOKEN = "sk-yqgmhvxaiwixzzncrnnnchdqqkruaeijpaeqmpwtxnajpbml";
    ...
    public static String generateBadReview(String prompt, String apiToken) {
        try {
            ...
            Request request = new Request.Builder()
                    ...
                    .addHeader("Authorization", "Bearer " + "sk-yqgmhvxaiwixzzncrnnnchdqqkruaeijpaeqmpwtxnajpbml")
