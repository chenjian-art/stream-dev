package com.cj.realtime_Dim.flinkfcation;
...
public class Tablepeocessfcation extends BroadcastProcessFunction<JSONObject, CommonTable, Tuple2<JSONObject, CommonTable>>{
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        List<CommonTable> commonTables = JdbsUtils.queryList(mySQLConnection, "select * from gmall2025_config.table_process_dim", CommonTable.class);
