        ...
        SingleOutputStreamOperator<JSONObject> RepairDs = jsonObjectStringKeyedStream.map(new RichMapFunction<JSONObject, JSONObject>() {
            ...
            public void open(Configuration parameters) throws Exception {
                ValueStateDescriptor<String> valueStateDescriptor
                        = new ValueStateDescriptor<String>("lastStartTime", String.class);
            ...
            public JSONObject map(JSONObject jsonObject) throws Exception {
                ...
                //从状态中获取首次访问日期
                String lastVisitDate = lastStartTime.value();
                //获取当前访问日期
                ...
                if ("1".equals(isNew)) {
                    ...
                    if (StringUtils.isEmpty(lastVisitDate)) {
                        ...
                        lastStartTime.update(curVisitDate);
                    }
                    else {
                    ...
                    if (StringUtils.isEmpty(lastVisitDate)) {
                        ...
                        lastStartTime.update(yesterDay);
                    }
                }
                return jsonObject;
            }
...
//        对日志数据进行分流
        SingleOutputStreamOperator<String> pageDS = RepairDs.process(new ProcessFunction<JSONObject, String>() {
            @Override
