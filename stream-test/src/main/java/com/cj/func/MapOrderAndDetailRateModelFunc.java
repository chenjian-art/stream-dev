...
import com.cj.base.DimSkuInfoMsg;
...
/**
 * @Package com.cj.func.MapOrderAndDetailRateModelFunc
 * @Author chen.jian
 * @Date 2025/5/15 下午4:43
 * @description:
 */
public class MapOrderAndDetailRateModelFunc extends RichMapFunction<JSONObject,JSONObject> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        String querySkuSql = "select sku_info.id as skuid,      \n" +
                ...
                "from gmall_config.sku_info              \n" +
                "join gmall_config.spu_info              \n" +
                "on sku_info.spu_id = spu_info.id       \n" +
                "join gmall_config.base_trademark        \n" +
                "on gmall_config.spu_info.tm_id = gmall_config.base_trademark.id";
