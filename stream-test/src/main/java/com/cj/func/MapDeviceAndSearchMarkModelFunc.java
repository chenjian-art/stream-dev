...
import com.cj.base.DimCategoryCompare;
...
/**
 * @Package com.cj.func.MapDeviceAndSearchMarkModelFunc
 * @Author chen.jian
 * @Date 2025/5/15 下午4:26
 * @description:
 */
public class MapDeviceAndSearchMarkModelFunc extends RichMapFunction<JSONObject,JSONObject> {
    ...
    public void open(Configuration parameters) throws Exception {
        connection = JdbcUtils.getMySQLConnection(
                ...
                "root",
                "root");
        String sql = "select id, category_name, search_category from gmall_config.category_compare_dic;";
